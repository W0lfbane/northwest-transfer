...
RSpec.describe TasksController, type: :controller do
  ...
  let(:invalid_attributes) { FactoryGirl.attributes_for(:task, :name => nil)}
  ...
  describe "POST #create" do
    ...
    context "with valid params" do
      it "creates a new Task" do
        expect {
          post :create, params: {:resource_controller => "projects", :resource_id => @project.id, task: valid_attributes}
    ...
    context "with invalid params" do
      ...
      it "will not increase the count of Tasks" do
        expect {
          post :create, params: {:resource_controller => "projects", :resource_id => @project.id, task: invalid_attributes}
  ...
  describe "PUT #update" do
    ...
    context "with valid params" do
      let(:new_attributes) {FactoryGirl.attributes_for(:task,
        :name => " Level the dinning room table.")
      }

      it "updates the requested task" do
        task = Task.create! valid_attributes
        put :update, params: {:resource_controller => "projects", :resource_id => @project.id, id: task.to_param, task: new_attributes}
        expect(task.name).to eq new_attributes
      end
